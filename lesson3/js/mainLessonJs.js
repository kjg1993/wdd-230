...
const showPicture = () => {
	const imgDomain = document.createElement("img");

	imgDomain.setAttribute("src", "images/name_domain.png");
	imgDomain.setAttribute(
		"alt",
...
btn.addEventListener("click", showPicture);
